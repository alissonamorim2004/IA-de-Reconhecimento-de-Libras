...
hands = mp_hands.Hands(static_image_mode=False, max_num_hands=2, min_detection_confidence=0.7)  # Mudar para 'static_image_mode=False' para vídeo
...
known_hands = []
known_labels = []
labels = ['A', 'B', 'C', 'D', 'E']  # Lista de rótulos para as letras A, B, C, D e E
